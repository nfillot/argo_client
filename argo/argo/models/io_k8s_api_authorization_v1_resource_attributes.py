...
class IoK8sApiAuthorizationV1ResourceAttributes(object):
    ...
    def __init__(self, group=None, name=None, namespace=None, resource=None, subresource=None, verb=None, version=None):  # noqa: E501
        """IoK8sApiAuthorizationV1ResourceAttributes - a model defined in Swagger"""  # noqa: E501
        self._group = None
        self._name = None
    ...
    @property
    def group(self):
        """Gets the group of this IoK8sApiAuthorizationV1ResourceAttributes.  # noqa: E501

        Group is the API Group of the Resource.  \"*\" means all.  # noqa: E501

        :return: The group of this IoK8sApiAuthorizationV1ResourceAttributes.  # noqa: E501
        :rtype: str
        """
        return self._group
    ...
    @property
    def name(self):
        """Gets the name of this IoK8sApiAuthorizationV1ResourceAttributes.  # noqa: E501

        Name is the name of the resource being requested for a \"get\" or deleted for a \"delete\". \"\" (empty) means all.  # noqa: E501

        :return: The name of this IoK8sApiAuthorizationV1ResourceAttributes.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @property
    def namespace(self):
        """Gets the namespace of this IoK8sApiAuthorizationV1ResourceAttributes.  # noqa: E501

        Namespace is the namespace of the action being requested.  Currently, there is no distinction between no namespace and all namespaces \"\" (empty) is defaulted for LocalSubjectAccessReviews \"\" (empty) is empty for cluster-scoped resources \"\" (empty) means \"all\" for namespace scoped resources from a SubjectAccessReview or SelfSubjectAccessReview  # noqa: E501

        :return: The namespace of this IoK8sApiAuthorizationV1ResourceAttributes.  # noqa: E501
        :rtype: str
        """
    ...
    @property
    def resource(self):
        """Gets the resource of this IoK8sApiAuthorizationV1ResourceAttributes.  # noqa: E501

        Resource is one of the existing resource types.  \"*\" means all.  # noqa: E501

        :return: The resource of this IoK8sApiAuthorizationV1ResourceAttributes.  # noqa: E501
        :rtype: str
        """
    ...
    def subresource(self):
        """Gets the subresource of this IoK8sApiAuthorizationV1ResourceAttributes.  # noqa: E501

        Subresource is one of the existing resource types.  \"\" means none.  # noqa: E501

        :return: The subresource of this IoK8sApiAuthorizationV1ResourceAttributes.  # noqa: E501
        :rtype: str
        """
    ...
    @property
    def verb(self):
        """Gets the verb of this IoK8sApiAuthorizationV1ResourceAttributes.  # noqa: E501

        Verb is a kubernetes resource API verb, like: get, list, watch, create, update, delete, proxy.  \"*\" means all.  # noqa: E501

        :return: The verb of this IoK8sApiAuthorizationV1ResourceAttributes.  # noqa: E501
        :rtype: str
        """
        return self._verb
    ...
    @property
    def version(self):
        """Gets the version of this IoK8sApiAuthorizationV1ResourceAttributes.  # noqa: E501

        Version is the API Version of the Resource.  \"*\" means all.  # noqa: E501

        :return: The version of this IoK8sApiAuthorizationV1ResourceAttributes.  # noqa: E501
        :rtype: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IoK8sApiAuthorizationV1ResourceAttributes, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IoK8sApiAuthorizationV1ResourceAttributes):
            return False
