...
**conditions** | [**list[IoK8sApiAppsV1beta2DaemonSetCondition]**](IoK8sApiAppsV1beta2DaemonSetCondition.md) | Represents the latest available observations of a DaemonSet&#x27;s current state. | [optional] 
