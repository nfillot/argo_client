...
**conditions** | [**list[IoK8sApiAppsV1beta2ReplicaSetCondition]**](IoK8sApiAppsV1beta2ReplicaSetCondition.md) | Represents the latest available observations of a replica set&#x27;s current state. | [optional] 
