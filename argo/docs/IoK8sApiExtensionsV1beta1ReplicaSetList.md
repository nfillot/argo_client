...
**items** | [**list[IoK8sApiExtensionsV1beta1ReplicaSet]**](IoK8sApiExtensionsV1beta1ReplicaSet.md) | List of ReplicaSets. More info: https://kubernetes.io/docs/concepts/workloads/controllers/replicationcontroller | 
