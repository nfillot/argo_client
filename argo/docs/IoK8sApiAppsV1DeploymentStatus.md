...
**conditions** | [**list[IoK8sApiAppsV1DeploymentCondition]**](IoK8sApiAppsV1DeploymentCondition.md) | Represents the latest available observations of a deployment&#x27;s current state. | [optional] 
