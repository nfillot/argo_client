...
**items** | [**list[IoK8sApiAdmissionregistrationV1beta1MutatingWebhookConfiguration]**](IoK8sApiAdmissionregistrationV1beta1MutatingWebhookConfiguration.md) | List of MutatingWebhookConfiguration. | 
