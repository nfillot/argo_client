...
api_instance = argo.AuthenticationV1beta1Api(argo.ApiClient(configuration))
body = argo.IoK8sApiAuthenticationV1beta1TokenReview() # IoK8sApiAuthenticationV1beta1TokenReview | 
