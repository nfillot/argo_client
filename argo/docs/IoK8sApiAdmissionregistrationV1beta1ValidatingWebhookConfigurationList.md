...
**items** | [**list[IoK8sApiAdmissionregistrationV1beta1ValidatingWebhookConfiguration]**](IoK8sApiAdmissionregistrationV1beta1ValidatingWebhookConfiguration.md) | List of ValidatingWebhookConfiguration. | 
