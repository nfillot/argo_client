...
**items** | [**list[IoK8sApiAutoscalingV2beta1HorizontalPodAutoscaler]**](IoK8sApiAutoscalingV2beta1HorizontalPodAutoscaler.md) | items is the list of horizontal pod autoscaler objects. | 
