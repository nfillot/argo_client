...
**webhooks** | [**list[IoK8sApiAdmissionregistrationV1beta1Webhook]**](IoK8sApiAdmissionregistrationV1beta1Webhook.md) | Webhooks is a list of webhooks and the affected resources and operations. | [optional] 
