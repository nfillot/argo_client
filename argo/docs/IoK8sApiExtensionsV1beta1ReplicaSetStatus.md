...
**conditions** | [**list[IoK8sApiExtensionsV1beta1ReplicaSetCondition]**](IoK8sApiExtensionsV1beta1ReplicaSetCondition.md) | Represents the latest available observations of a replica set&#x27;s current state. | [optional] 
