...
class IoK8sApiCertificatesV1beta1CertificateSigningRequestSpec(object):
    ...
    def __init__(self, extra=None, groups=None, request=None, uid=None, usages=None, username=None):  # noqa: E501
        """IoK8sApiCertificatesV1beta1CertificateSigningRequestSpec - a model defined in Swagger"""  # noqa: E501
        self._extra = None
        self._groups = None
        self._request = None
        self._uid = None
    ...
    @property
    def extra(self):
        """Gets the extra of this IoK8sApiCertificatesV1beta1CertificateSigningRequestSpec.  # noqa: E501

        Extra information about the requesting user. See user.Info interface for details.  # noqa: E501

        :return: The extra of this IoK8sApiCertificatesV1beta1CertificateSigningRequestSpec.  # noqa: E501
    ...
    @property
    def groups(self):
        """Gets the groups of this IoK8sApiCertificatesV1beta1CertificateSigningRequestSpec.  # noqa: E501

        Group information about the requesting user. See user.Info interface for details.  # noqa: E501

        :return: The groups of this IoK8sApiCertificatesV1beta1CertificateSigningRequestSpec.  # noqa: E501
        :rtype: list[str]
        """
        return self._groups
    ...
    @property
    def request(self):
        """Gets the request of this IoK8sApiCertificatesV1beta1CertificateSigningRequestSpec.  # noqa: E501

        Base64-encoded PKCS#10 CSR data  # noqa: E501

        :return: The request of this IoK8sApiCertificatesV1beta1CertificateSigningRequestSpec.  # noqa: E501
        :rtype: str
        """
    ...
    @property
    def uid(self):
        """Gets the uid of this IoK8sApiCertificatesV1beta1CertificateSigningRequestSpec.  # noqa: E501

        UID information about the requesting user. See user.Info interface for details.  # noqa: E501

        :return: The uid of this IoK8sApiCertificatesV1beta1CertificateSigningRequestSpec.  # noqa: E501
        :rtype: str
        """
        return self._uid
    ...
    @property
    def usages(self):
        """Gets the usages of this IoK8sApiCertificatesV1beta1CertificateSigningRequestSpec.  # noqa: E501
        ...
        :return: The usages of this IoK8sApiCertificatesV1beta1CertificateSigningRequestSpec.  # noqa: E501
        :rtype: list[str]
        """
        return self._usages
    ...
    @property
    def username(self):
        """Gets the username of this IoK8sApiCertificatesV1beta1CertificateSigningRequestSpec.  # noqa: E501

        Information about the requesting user. See user.Info interface for details.  # noqa: E501

        :return: The username of this IoK8sApiCertificatesV1beta1CertificateSigningRequestSpec.  # noqa: E501
        :rtype: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IoK8sApiCertificatesV1beta1CertificateSigningRequestSpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IoK8sApiCertificatesV1beta1CertificateSigningRequestSpec):
            return False
