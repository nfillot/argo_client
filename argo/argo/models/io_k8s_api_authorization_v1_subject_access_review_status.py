...
class IoK8sApiAuthorizationV1SubjectAccessReviewStatus(object):
    ...
    def __init__(self, allowed=None, denied=None, evaluation_error=None, reason=None):  # noqa: E501
        """IoK8sApiAuthorizationV1SubjectAccessReviewStatus - a model defined in Swagger"""  # noqa: E501
        self._allowed = None
        self._denied = None
    ...
    @property
    def allowed(self):
        """Gets the allowed of this IoK8sApiAuthorizationV1SubjectAccessReviewStatus.  # noqa: E501

        Allowed is required. True if the action would be allowed, false otherwise.  # noqa: E501

        :return: The allowed of this IoK8sApiAuthorizationV1SubjectAccessReviewStatus.  # noqa: E501
        :rtype: bool
        """
    ...
    @property
    def denied(self):
        """Gets the denied of this IoK8sApiAuthorizationV1SubjectAccessReviewStatus.  # noqa: E501
        ...
        :return: The denied of this IoK8sApiAuthorizationV1SubjectAccessReviewStatus.  # noqa: E501
        :rtype: bool
        """
        return self._denied
    ...
    def evaluation_error(self):
        """Gets the evaluation_error of this IoK8sApiAuthorizationV1SubjectAccessReviewStatus.  # noqa: E501

        EvaluationError is an indication that some error occurred during the authorization check. It is entirely possible to get an error and be able to continue determine authorization status in spite of it. For instance, RBAC can be missing a role, but enough roles are still present and bound to reason about the request.  # noqa: E501

        :return: The evaluation_error of this IoK8sApiAuthorizationV1SubjectAccessReviewStatus.  # noqa: E501
        :rtype: str
        """
    ...
    @property
    def reason(self):
        """Gets the reason of this IoK8sApiAuthorizationV1SubjectAccessReviewStatus.  # noqa: E501

        Reason is optional.  It indicates why a request was allowed or denied.  # noqa: E501

        :return: The reason of this IoK8sApiAuthorizationV1SubjectAccessReviewStatus.  # noqa: E501
        :rtype: str
        """
        return self._reason
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IoK8sApiAuthorizationV1SubjectAccessReviewStatus, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IoK8sApiAuthorizationV1SubjectAccessReviewStatus):
            return False
