...
> IoK8sApiSchedulingV1PriorityClass create_scheduling_v1_priority_class(body, pretty=pretty, dry_run=dry_run, field_manager=field_manager)
...
api_instance = argo.SchedulingV1Api(argo.ApiClient(configuration))
body = argo.IoK8sApiSchedulingV1PriorityClass() # IoK8sApiSchedulingV1PriorityClass | 
...
try:
    api_response = api_instance.create_scheduling_v1_priority_class(body, pretty=pretty, dry_run=dry_run, field_manager=field_manager)
    pprint(api_response)
...
> IoK8sApimachineryPkgApisMetaV1Status delete_scheduling_v1_collection_priority_class(pretty=pretty, _continue=_continue, field_selector=field_selector, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
...
try:
    api_response = api_instance.delete_scheduling_v1_collection_priority_class(pretty=pretty, _continue=_continue, field_selector=field_selector, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
    pprint(api_response)
except ApiException as e:
...
> IoK8sApimachineryPkgApisMetaV1Status delete_scheduling_v1_priority_class(name, body=body, pretty=pretty, dry_run=dry_run, grace_period_seconds=grace_period_seconds, orphan_dependents=orphan_dependents, propagation_policy=propagation_policy)
...
try:
    api_response = api_instance.delete_scheduling_v1_priority_class(name, body=body, pretty=pretty, dry_run=dry_run, grace_period_seconds=grace_period_seconds, orphan_dependents=orphan_dependents, propagation_policy=propagation_policy)
    pprint(api_response)
except ApiException as e:
...
> IoK8sApiSchedulingV1PriorityClassList list_scheduling_v1_priority_class(pretty=pretty, _continue=_continue, field_selector=field_selector, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
...
try:
    api_response = api_instance.list_scheduling_v1_priority_class(pretty=pretty, _continue=_continue, field_selector=field_selector, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
    pprint(api_response)
except ApiException as e:
...
> IoK8sApiSchedulingV1PriorityClass patch_scheduling_v1_priority_class(body, name, pretty=pretty, dry_run=dry_run, field_manager=field_manager, force=force)
...
try:
    api_response = api_instance.patch_scheduling_v1_priority_class(body, name, pretty=pretty, dry_run=dry_run, field_manager=field_manager, force=force)
    pprint(api_response)
except ApiException as e:
...
> IoK8sApiSchedulingV1PriorityClass read_scheduling_v1_priority_class(name, pretty=pretty, exact=exact, export=export)
...
try:
    api_response = api_instance.read_scheduling_v1_priority_class(name, pretty=pretty, exact=exact, export=export)
    pprint(api_response)
except ApiException as e:
...
> IoK8sApiSchedulingV1PriorityClass replace_scheduling_v1_priority_class(body, name, pretty=pretty, dry_run=dry_run, field_manager=field_manager)
...
try:
    api_response = api_instance.replace_scheduling_v1_priority_class(body, name, pretty=pretty, dry_run=dry_run, field_manager=field_manager)
    pprint(api_response)
except ApiException as e:
...
> IoK8sApimachineryPkgApisMetaV1WatchEvent watch_scheduling_v1_priority_class(name, _continue=_continue, field_selector=field_selector, label_selector=label_selector, limit=limit, pretty=pretty, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
...
try:
    api_response = api_instance.watch_scheduling_v1_priority_class(name, _continue=_continue, field_selector=field_selector, label_selector=label_selector, limit=limit, pretty=pretty, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
    pprint(api_response)
except ApiException as e:
...
> IoK8sApimachineryPkgApisMetaV1WatchEvent watch_scheduling_v1_priority_class_list(_continue=_continue, field_selector=field_selector, label_selector=label_selector, limit=limit, pretty=pretty, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
...
try:
    api_response = api_instance.watch_scheduling_v1_priority_class_list(_continue=_continue, field_selector=field_selector, label_selector=label_selector, limit=limit, pretty=pretty, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
    pprint(api_response)
except ApiException as e:
