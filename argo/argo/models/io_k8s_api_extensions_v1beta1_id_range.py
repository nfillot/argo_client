...
class IoK8sApiExtensionsV1beta1IDRange(object):
    ...
    def __init__(self, max=None, min=None):  # noqa: E501
        """IoK8sApiExtensionsV1beta1IDRange - a model defined in Swagger"""  # noqa: E501
        self._max = None
        self._min = None
    ...
    @property
    def max(self):
        """Gets the max of this IoK8sApiExtensionsV1beta1IDRange.  # noqa: E501

        max is the end of the range, inclusive.  # noqa: E501

        :return: The max of this IoK8sApiExtensionsV1beta1IDRange.  # noqa: E501
        :rtype: int
        """
        return self._max
    ...
    @property
    def min(self):
        """Gets the min of this IoK8sApiExtensionsV1beta1IDRange.  # noqa: E501

        min is the start of the range, inclusive.  # noqa: E501

        :return: The min of this IoK8sApiExtensionsV1beta1IDRange.  # noqa: E501
        :rtype: int
        """
        return self._min
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IoK8sApiExtensionsV1beta1IDRange, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IoK8sApiExtensionsV1beta1IDRange):
            return False
