...
**conditions** | [**list[IoK8sApiAppsV1beta2DeploymentCondition]**](IoK8sApiAppsV1beta2DeploymentCondition.md) | Represents the latest available observations of a deployment&#x27;s current state. | [optional] 
