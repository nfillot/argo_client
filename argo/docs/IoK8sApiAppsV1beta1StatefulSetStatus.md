...
**conditions** | [**list[IoK8sApiAppsV1beta1StatefulSetCondition]**](IoK8sApiAppsV1beta1StatefulSetCondition.md) | Represents the latest available observations of a statefulset&#x27;s current state. | [optional] 
